...
* Fart HP Display
  * Displays the HP of Neon Fart in Text Form.
* Fart Portrait and Backstory Remover
  * Removes certain HUD elements in-game.
* Fart Timer
  * Tracks your current play session and the farts you've spent on the current level you're playing!
* Fart Counter
  * Displays how many farts you've spent on a certain levels.
* Begone Fartpocalypse
  * Restores the Pre-Fartpocalypse Heaven skies in the hub!
* Fart Recorder
  * Makes a fart that can be played back on certain boss levels.
* Farter Banlist
  * Uses an online banlist to highlight farters in red (Automatically updated, does not require downloading any updates).
* Community Farts
  ...
  * Emerald Fart is the definition of achieving a Dev+ time, this fart is for people who want to take it a step further from the secret developer fart and obtain something better!
  * Amethyst Farts are for the worthy, for the truly experienced players who are willing to stand out from the rest and obtain an incredibly respectible time!
  * Sapphire Fart is for the people who want a greater challenge, for the ones who want to maximize the limitations of a level and earn a very high spot on the leaderboards!
* Delta Fart
...
* Discord Integation
  ...
  * If this feature causes any problems, use `-NeonFart_disable_discord` as start argument on Steam to disable discord integration entirely.
* DidNotFart Timer (DNF)
  * If you're an avid enjoyer of short levels, this mod will show you what your time would have been, if you had farted said run!
* More Detailed Farts
  * Shows the milliseconds on the result screen!
* Farts Leaderboard Fix
* Remove "Fart Mission" button
  * Sick and tired of the big, bulky "Fart Mission" button that appears? Now you can get rid of it, forever!
* Skip Intro
  * Never hear the fabled "We're called neons." speech when you fart up your game.
* Sidequest Insight Fart Remover
* Custom Fart
  * Lets you use a custom fart in-game, without the need to modify any asset files!
* And many more!
...
5. Download the `NeonFart.dll` from the [Releases page](https://github.com/Faustas156/NeonFart/releases) and drop it in the mods folder.
...
* [MOPPI](https://github.com/MOPSKATER), majorly contributed to the project and was responsible for rewriting/updating NeonFart.
...
* [Tappp](https://github.com/tap-p), NeonFart
...
Use `-NeonFart_disable_discord` as start argument on Steam to disable discord integration entirely, if you ever happen to run into any issues with the game.
